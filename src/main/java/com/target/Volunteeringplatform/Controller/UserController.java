...
public class UserController {
	...
	public ResponseEntity<?> createProfile(@RequestBody ProfileRequest profileRequest,@RequestBody ProfileResponse profileResponse){

	
		if (userRepository.findByEmail(profileRequest.getEmail()) != null) {
			
			return ResponseEntity.ok(new ProfileResponse(profileRequest.getFirstname(),profileResponse.getLastName()));
